package com.apps.allo24.activities_fragments.activity_intro_slider;
...
import com.apps.allo24.adapters.IntroAdapter;
import com.apps.allo24.databinding.ActivityIntroSliderBinding;
...
public class IntroSliderActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        if (type==0){
            binding.tvTitle.setText(Html.fromHtml(getString(R.string.welcome_in_allo24)));
